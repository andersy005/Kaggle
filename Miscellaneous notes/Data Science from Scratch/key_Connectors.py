...
for i, j in friendships:
    # this works because users[i] id the user whose id is i
...
a = sorted(num_friends_by_id,  # get it sorted
...
def not_friends(user, other_user):
    ...
    that is, if he is not the same as all the people in user["friends"]"""
